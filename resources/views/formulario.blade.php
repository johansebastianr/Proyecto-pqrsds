...
<div class="container">
    ...
    <form action="{{ route('formulario.index') }}" method="POST">
    @csrf
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                <label for="tipoPqrsd">Tipo de clientes</label>
                    <select class="form-control" id="tipoCliente" name="tipoCliente" placeholder="Selecciona una opción">
                        <option value="" disabled selected>Selecciona una opción</option>
    ...
    <br>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="urlPdf">Adjuntar archivo PDF</label>
                    <input type="file" class="form-control-file" id="urlPdf" name="urlPdf">
                </div>
            </div>
